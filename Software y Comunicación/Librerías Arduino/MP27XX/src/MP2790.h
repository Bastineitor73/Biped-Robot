...
public:
    ...
    uint16_t readReg(RegDes reg);
    bool writeReg(RegDes reg, uint16_t value);
    ...
    //Register methods
        //Main register
    bool getInterrupts(bool* intFlags);
    bool getCellUVStatus(bool* cellOVflags);
    bool getCellOVStatus(bool* cellOVflags);
    bool getCellMismatchStatus(bool* cellMisMatchFlags);
    bool getCellDeadStatus(bool* cellDeadFlags);
    bool getCellOpenWireStatus(bool* cellOpenWireFlags);
    void getNTCreadings(uint16_t* ntcValues);               //For NTC 1-4
    bool getNTCHotColdDSGStatus(bool* ntcHotColdDSGFlags);
    bool getNTCHotColdCHGStatus(bool* ntcHotColdCHGFlags);
